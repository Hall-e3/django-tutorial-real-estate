...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+256704690358"
    )
    ...
    country = CountryField(
        verbose_name=_("Country"), default="UG", blank=True, null=True
    )
    ...
    top_seller = models.BooleanField(
        verbose_name=_("Top Seller"),
        default=False,
        help_text=_("Are you a top seller?"),
    )
    ...
    rating = models.DecimalField(
        verbose_name=_("Ratings"), max_digits=4, decimal_places=2, null=True, blank=True
    )
