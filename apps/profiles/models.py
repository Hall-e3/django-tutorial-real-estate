...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"),max_length=30, default="+256704690358")
    ...
    rating = models.DecimalField(verbose_name=_("Ratings"),max_digits=4,decimal_places=2,null=True,blank=True)
