...
class Property(TimeStampedUUIDModel):
    ...
    tax = models.DecimalField(verbose_name=_("Property Tax"),max_digits=6,default=0.15,help_text="15% property tax charged",decimal_places=2)
    ...
    cover_photo = models.ImageField(verbose_name=_("Main Photo"),default="/house_sample.jpg",blank=True)
    ...
    def save(self,*args,**kwargs):
        ...
        self.ref_code = "".join(random.choices(string.ascii_uppercase + strings.digits, k=20))
