...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="UG", blank_label="(select country)"
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Kampala")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=180, default="256"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=180, default="Makerere University"
    )
    ...
    cover_photo = models.ImageField(
        verbose_name=_("Main Photo"), default="/house_sample.jpg", blank=True
    )
